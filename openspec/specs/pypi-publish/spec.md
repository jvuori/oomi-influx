...
Publish the package to PyPI automatically via a GitHub Actions workflow triggered on GitHub Release publication, using OIDC Trusted Publishing (no stored API tokens).
